...
class MainSeeder extends Seeder
{
    public function run()
    {
        ...
        // 2. Types de congé - insert individuels pour SQLite3
        ...
        // 3. Employes - insert individuels pour SQLite3
        ...
        // 4. Soldes initiaux pour chaque employé - insert individuels pour SQLite3
        $annee = date('Y');
