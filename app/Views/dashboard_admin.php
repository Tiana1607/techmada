        ...
        <div class="app-wrap">
            ...
            <aside class="sidebar">
                <div class="sidebar-brand">
                    <div class="sidebar-logo-icon" style="background:var(--ink);border:1px solid rgba(255,255,255,.15)"><i
                            class="bi bi-shield-check" style="color:var(--leaf)"></i></div>
                ...
                <div class="sidebar-user">
                    <div class="s-user-row">
                        ...
                        <a href="#page-login" style="margin-left:auto;color:rgba(255,255,255,.25);font-size:1.1rem"><i
            ...
            <div class="main">
                <div class="topbar">
                    ...
                    <div class="topbar-actions">
                        <a href="#page-admin-employes" class="btn-forest" style="padding:7px 14px;font-size:.82rem"><i
                                class="bi bi-person-plus"></i> Ajouter un employé</a>
                    </div>
                </div>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 320px;gap:1.5rem;align-items:start">
                        ...
                        <div class="data-card" style="margin:0">
                            <div class="data-card-head">
                                ...
                                <a href="#page-liste-rh" style="font-size:.8rem;color:var(--forest);text-decoration:none">Tout voir
                                    →</a>
                            </div>
                            <table class="tbl">
                                <thead>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div style="display:flex;align-items:center;gap:7px">
                                                <div class="avatar av-green" style="width:28px;height:28px;font-size:.62rem">SR</div><span
                                                    class="td-name" style="font-size:.84rem">Soa Rakoto</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="display:flex;align-items:center;gap:7px">
                                                <div class="avatar av-amber" style="width:28px;height:28px;font-size:.62rem">TF</div><span
                                                    class="td-name" style="font-size:.84rem">Tsiry Fidy</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="display:flex;align-items:center;gap:7px">
                                                <div class="avatar av-blue" style="width:28px;height:28px;font-size:.62rem">HA</div><span
                                                    class="td-name" style="font-size:.84rem">Haja Andria</span>
                                            </div>
                                        </td>
                                        <td><span class="type-badge t-annuel">Annuel</span></td>
                                        <td class="td-mono">5 j</td>
                        ...
                        <div style="display:flex;flex-direction:column;gap:1rem">
                            <div class="data-card" style="margin:0">
                                <div class="data-card-head">
                                    <h3><i class="bi bi-person-slash" style="color:var(--muted);margin-right:5px"></i>Absents aujourd'hui
                                    </h3>
                                </div>
                            ...
                            <div class="flash flash-warn" style="margin:0">
                                ...
                                <span style="font-size:.8rem">2 employés ont un solde critique (≤ 2 jours). <a href="#"
